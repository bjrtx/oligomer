...
# Read the txt file of the chimera commands in the format of the arrangments doc
...
for z, (line_Bfr1, line_Bfr2) in enumerate(zip(Bfr1_lines, Bfr2_lines), start=1):
    ...
    new_name = (
        f"{basename}_{z}"  # add the basename numbers from 1 to the number of structures
    )
    rc(
